...
(function () {
  ...
  document.querySelector("html").classList.contains("is-builder") || document.addEventListener("click", function (a) {
    a = a.target; if (!a.classList.contains("nav-link") && !a.parentNode.classList.contains("nav-link")) {
      var b = document.querySelector("#navbarSupportedContent"), e = document.querySelector(".navbar-dropdown"), c = b.classList.contains("show"), d = a.closest(".nav-item a:not(.dropdown-toggle)"), e = e.classList.contains("collapsed"); (window.matchMedia("(max-width: 991px)").matches || e) && (c && !a.closest(".navbar-collapse") ||
